...
from streamwatch.async_stream_checker import AsyncStreamChecker, create_async_stream_checker
from streamwatch.models import StreamStatus
from streamwatch.result import Result
...
class TestAsyncStreamChecker:
    ...
    async def test_fetch_metadata_async_success(self, async_checker):
        ...
        with patch.object(async_checker, '_run_streamlink_metadata_async') as mock_fetch:
    ...
    async def test_fetch_live_streams_async_integration(self, async_checker):
        ...
        with patch.object(async_checker, '_run_streamlink_check_async') as mock_check:
            ...
            with patch.object(async_checker, '_run_streamlink_metadata_async') as mock_metadata:
    ...
    async def test_semaphore_limits_concurrency(self, async_checker):
        ...
        with patch.object(async_checker, '_run_streamlink_check_async', side_effect=mock_check_with_tracking):
...
async def test_module_level_async_functions():
    ...
    from streamwatch.async_stream_checker import check_multiple_streams_async, fetch_live_streams_async
    
    urls = ["https://example.com/stream1", "https://example.com/stream2"]
    
    with patch('streamwatch.async_stream_checker.AsyncStreamChecker') as mock_checker_class:
